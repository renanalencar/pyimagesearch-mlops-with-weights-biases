...
def parse_args(default_cfg):
    ...
    parser.add_argument(
        "--image_size", type=int, default=default_cfg.image_size, help="image size"
    )
    parser.add_argument(
        "--batch_size", type=int, default=default_cfg.batch_size, help="batch size"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_arch",
        type=str,
        default=default_cfg.model_arch,
